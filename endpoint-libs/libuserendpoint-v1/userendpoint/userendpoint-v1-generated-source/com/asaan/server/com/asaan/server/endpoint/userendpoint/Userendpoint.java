...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
	 ...
	 *
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link GetUserAddresses#execute()} method to invoke the remote operation.
	 *
	 * @return the request
	 */
	...
	public class GetUserAddresses extends
		 ...
		 * {@link GetUserAddresses#execute()} method to invoke the remote
		 * operation.
		 * <p>
		 * {@link GetUserAddresses#initialize(com.google.api.client.googleapis.services.Abs tractGoogleClientRequest)}
	 ...
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link GetUserByEmail#execute()} method to invoke the remote operation.
	 *
	 * @param email
	 * @return the request
	 */
	...
	public class GetUserByEmail extends
		 ...
		 * This request holds the parameters needed by the the userendpoint
		 * server. After setting any optional parameters, call the
		 * {@link GetUserByEmail#execute()} method to invoke the remote
		 * operation.
		 * <p>
		 * {@link GetUserByEmail#initialize(com.google.api.client.googleapis.services.Abstr actGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
	 ...
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link GetUserCards#execute()} method to invoke the remote operation.
	 *
	 * @return the request
	 */
	...
	public class GetUserCards extends
		 ...
		 * {@link GetUserCards#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link GetUserCards#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
	 ...
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link SaveUser#execute()} method to invoke the remote operation.
	 *
	 * @param content
	 *            the
	...
	public class SaveUser extends UserendpointRequest<Void> {
		 ...
		 * {@link SaveUser#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link SaveUser#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
	 ...
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link SaveUserAddress#execute()} method to invoke the remote operation.
	 *
	 * @param content
	 *            the
	 ...
	 * @return the request
	 */
	public SaveUserAddress saveUserAddress(
	...
	public class SaveUserAddress extends
		 ...
		 * This request holds the parameters needed by the the userendpoint
		 * server. After setting any optional parameters, call the
		 * {@link SaveUserAddress#execute()} method to invoke the remote
		 * operation.
		 * <p>
		 * {@link SaveUserAddress#initialize(com.google.api.client.googleapis.services.Abst ractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
	 ...
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link SaveUserCard#execute()} method to invoke the remote operation.
	 *
	 * @param content
	 *            the
	...
	public class SaveUserCard extends
		 ...
		 * {@link SaveUserCard#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link SaveUserCard#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
	 ...
	 * This request holds the parameters needed by the userendpoint server.
	 * After setting any optional parameters, call the
	 * {@link SaveUserProfile#execute()} method to invoke the remote operation.
	 *
	 * @param content
	 *            the
	 *            {@link com.asaan.server.com.asaan.server.endpoint.userendpoint.model.User}
	...
	public class SaveUserProfile extends
		 ...
		 * This request holds the parameters needed by the the userendpoint
		 * server. After setting any optional parameters, call the
		 * {@link SaveUserProfile#execute()} method to invoke the remote
		 * operation.
		 * <p>
		 * {@link SaveUserProfile#initialize(com.google.api.client.googleapis.services.Abst ractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 *
