...
public class Storeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getStoreImages".
   *
   * This request holds the parameters needed by the storeendpoint server.  After setting any optional
   * parameters, call the {@link GetStoreImages#execute()} method to invoke the remote operation.
   *
   * @param storeId
   * @return the request
   */
  public GetStoreImages getStoreImages(java.lang.Long storeId) throws java.io.IOException {
    GetStoreImages result = new GetStoreImages(storeId);
    initialize(result);
    return result;
  }

  public class GetStoreImages extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImageCollection> {

    private static final String REST_PATH = "storeimagecollection/{storeId}";

    /**
     * Create a request for the method "getStoreImages".
     *
     * This request holds the parameters needed by the the storeendpoint server.  After setting any
     * optional parameters, call the {@link GetStoreImages#execute()} method to invoke the remote
     * operation. <p> {@link GetStoreImages#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected GetStoreImages(java.lang.Long storeId) {
      super(Storeendpoint.this, "POST", REST_PATH, null, com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImageCollection.class);
      this.storeId = com.google.api.client.util.Preconditions.checkNotNull(storeId, "Required parameter storeId must be specified.");
    }

    @Override
    public GetStoreImages setAlt(java.lang.String alt) {
      return (GetStoreImages) super.setAlt(alt);
    }

    @Override
    public GetStoreImages setFields(java.lang.String fields) {
      return (GetStoreImages) super.setFields(fields);
    }

    @Override
    public GetStoreImages setKey(java.lang.String key) {
      return (GetStoreImages) super.setKey(key);
    }

    @Override
    public GetStoreImages setOauthToken(java.lang.String oauthToken) {
      return (GetStoreImages) super.setOauthToken(oauthToken);
    }

    @Override
    public GetStoreImages setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetStoreImages) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetStoreImages setQuotaUser(java.lang.String quotaUser) {
      return (GetStoreImages) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetStoreImages setUserIp(java.lang.String userIp) {
      return (GetStoreImages) super.setUserIp(userIp);
    }
    ...
    public GetStoreImages setStoreId(java.lang.Long storeId) {
      this.storeId = storeId;
      return this;
    }

    @Override
    public GetStoreImages set(String parameterName, Object value) {
      return (GetStoreImages) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public GetStoreMenuItemsForMenu getStoreMenuItemsForMenu(java.lang.Long storeId, java.lang.Long menuPOSId) throws java.io.IOException {
    GetStoreMenuItemsForMenu result = new GetStoreMenuItemsForMenu(storeId, menuPOSId);
    initialize(result);
    return result;
  }
  ...
  public class GetStoreMenuItemsForMenu extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreMenuItemCollection> {
    ...
    private static final String REST_PATH = "storemenuitemcollection/{storeId}/{menuPOSId}";
     ...
     * @since 1.13
     */
    protected GetStoreMenuItemsForMenu(java.lang.Long storeId, java.lang.Long menuPOSId) {
    ...
    public GetStoreMenuItemsForMenu setMenuPOSId(java.lang.Long menuPOSId) {
   ...
   * @return the request
   */
  public GetStoreMenus getStoreMenus(java.lang.Long storeId) throws java.io.IOException {
    GetStoreMenus result = new GetStoreMenus(storeId);
    initialize(result);
    return result;
  }
  ...
  public class GetStoreMenus extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreMenuHierarchyCollection> {
    ...
    private static final String REST_PATH = "storemenuhierarchycollection/{storeId}";
  ...
  /**
   * Create a request for the method "getStoreSubmenusForMenu".
   *
   * This request holds the parameters needed by the storeendpoint server.  After setting any optional
   * parameters, call the {@link GetStoreSubmenusForMenu#execute()} method to invoke the remote
   * operation.
   *
   * @param storeId
   * @param menuPOSId
   * @return the request
   */
  public GetStoreSubmenusForMenu getStoreSubmenusForMenu(java.lang.Long storeId, java.lang.Long menuPOSId) throws java.io.IOException {
    GetStoreSubmenusForMenu result = new GetStoreSubmenusForMenu(storeId, menuPOSId);
    initialize(result);
    return result;
  }

  public class GetStoreSubmenusForMenu extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreMenuHierarchyCollection> {

    private static final String REST_PATH = "storemenuhierarchycollection/{storeId}/{menuPOSId}";

    /**
     * Create a request for the method "getStoreSubmenusForMenu".
     *
     * This request holds the parameters needed by the the storeendpoint server.  After setting any
     * optional parameters, call the {@link GetStoreSubmenusForMenu#execute()} method to invoke the
     * remote operation. <p> {@link GetStoreSubmenusForMenu#initialize(com.google.api.client.googleapi
     ...
     * @since 1.13
     */
    protected GetStoreSubmenusForMenu(java.lang.Long storeId, java.lang.Long menuPOSId) {
      super(Storeendpoint.this, "POST", REST_PATH, null, com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreMenuHierarchyCollection.class);
      this.storeId = com.google.api.client.util.Preconditions.checkNotNull(storeId, "Required parameter storeId must be specified.");
      this.menuPOSId = com.google.api.client.util.Preconditions.checkNotNull(menuPOSId, "Required parameter menuPOSId must be specified.");
    }
    ...
    @Override
    public GetStoreSubmenusForMenu setAlt(java.lang.String alt) {
      return (GetStoreSubmenusForMenu) super.setAlt(alt);
    }

    @Override
    public GetStoreSubmenusForMenu setFields(java.lang.String fields) {
      return (GetStoreSubmenusForMenu) super.setFields(fields);
    }

    @Override
    public GetStoreSubmenusForMenu setKey(java.lang.String key) {
      return (GetStoreSubmenusForMenu) super.setKey(key);
    }

    @Override
    public GetStoreSubmenusForMenu setOauthToken(java.lang.String oauthToken) {
      return (GetStoreSubmenusForMenu) super.setOauthToken(oauthToken);
    }

    @Override
    public GetStoreSubmenusForMenu setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetStoreSubmenusForMenu) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetStoreSubmenusForMenu setQuotaUser(java.lang.String quotaUser) {
      return (GetStoreSubmenusForMenu) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetStoreSubmenusForMenu setUserIp(java.lang.String userIp) {
      return (GetStoreSubmenusForMenu) super.setUserIp(userIp);
    }
    ...
    public GetStoreSubmenusForMenu setStoreId(java.lang.Long storeId) {
      this.storeId = storeId;
      return this;
    }
    ...
    public GetStoreSubmenusForMenu setMenuPOSId(java.lang.Long menuPOSId) {
      this.menuPOSId = menuPOSId;
      return this;
    }

    @Override
    public GetStoreSubmenusForMenu set(String parameterName, Object value) {
      return (GetStoreSubmenusForMenu) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public GetStores getStores() throws java.io.IOException {
    GetStores result = new GetStores();
    initialize(result);
    return result;
  }
  ...
  public class GetStores extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreCollection> {
    ...
    private static final String REST_PATH = "storecollection";
  ...
  /**
   * Create a request for the method "removeStoreImage".
   *
   * This request holds the parameters needed by the storeendpoint server.  After setting any optional
   * parameters, call the {@link RemoveStoreImage#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage}
   * @return the request
   */
  public RemoveStoreImage removeStoreImage(com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage content) throws java.io.IOException {
    RemoveStoreImage result = new RemoveStoreImage(content);
    initialize(result);
    return result;
  }

  public class RemoveStoreImage extends StoreendpointRequest<Void> {
     ...
     *
     * This request holds the parameters needed by the the storeendpoint server.  After setting any
     * optional parameters, call the {@link RemoveStoreImage#execute()} method to invoke the remote
     * operation. <p> {@link RemoveStoreImage#initialize(com.google.api.client.googleapis.services.Abs
     ...
     * @since 1.13
     */
    protected RemoveStoreImage(com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage content) {
      super(Storeendpoint.this, "POST", REST_PATH, content, Void.class);
    }

    @Override
    public RemoveStoreImage setAlt(java.lang.String alt) {
      return (RemoveStoreImage) super.setAlt(alt);
    }

    @Override
    public RemoveStoreImage setFields(java.lang.String fields) {
      return (RemoveStoreImage) super.setFields(fields);
    }

    @Override
    public RemoveStoreImage setKey(java.lang.String key) {
      return (RemoveStoreImage) super.setKey(key);
    }

    @Override
    public RemoveStoreImage setOauthToken(java.lang.String oauthToken) {
      return (RemoveStoreImage) super.setOauthToken(oauthToken);
    }

    @Override
    public RemoveStoreImage setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (RemoveStoreImage) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public RemoveStoreImage setQuotaUser(java.lang.String quotaUser) {
      return (RemoveStoreImage) super.setQuotaUser(quotaUser);
    }

    @Override
    public RemoveStoreImage setUserIp(java.lang.String userIp) {
      return (RemoveStoreImage) super.setUserIp(userIp);
    }

    @Override
    public RemoveStoreImage set(String parameterName, Object value) {
      return (RemoveStoreImage) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "saveStoreImage".
   *
   * This request holds the parameters needed by the storeendpoint server.  After setting any optional
   * parameters, call the {@link SaveStoreImage#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage}
   * @return the request
   */
  public SaveStoreImage saveStoreImage(com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage content) throws java.io.IOException {
    SaveStoreImage result = new SaveStoreImage(content);
    initialize(result);
    return result;
  }

  public class SaveStoreImage extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage> {

    private static final String REST_PATH = "saveStoreImage";

    /**
     * Create a request for the method "saveStoreImage".
     *
     * This request holds the parameters needed by the the storeendpoint server.  After setting any
     * optional parameters, call the {@link SaveStoreImage#execute()} method to invoke the remote
     * operation. <p> {@link SaveStoreImage#initialize(com.google.api.client.googleapis.services.Abstr
     * actGoogleClientRequest)} must be called to initialize this instance immediately after invoking
     * the constructor. </p>
     *
     * @param content the {@link com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage}
     * @since 1.13
     */
    protected SaveStoreImage(com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage content) {
      super(Storeendpoint.this, "POST", REST_PATH, content, com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StoreImage.class);
    }

    @Override
    public SaveStoreImage setAlt(java.lang.String alt) {
      return (SaveStoreImage) super.setAlt(alt);
    }

    @Override
    public SaveStoreImage setFields(java.lang.String fields) {
      return (SaveStoreImage) super.setFields(fields);
    }

    @Override
    public SaveStoreImage setKey(java.lang.String key) {
      return (SaveStoreImage) super.setKey(key);
    }

    @Override
    public SaveStoreImage setOauthToken(java.lang.String oauthToken) {
      return (SaveStoreImage) super.setOauthToken(oauthToken);
    }

    @Override
    public SaveStoreImage setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SaveStoreImage) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SaveStoreImage setQuotaUser(java.lang.String quotaUser) {
      return (SaveStoreImage) super.setQuotaUser(quotaUser);
    }

    @Override
    public SaveStoreImage setUserIp(java.lang.String userIp) {
      return (SaveStoreImage) super.setUserIp(userIp);
    }

    @Override
    public SaveStoreImage set(String parameterName, Object value) {
      return (SaveStoreImage) super.set(parameterName, value);
    }
  }
  ...
  public class SaveStorePOSConnection extends StoreendpointRequest<com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StorePOSConnection> {
    ...
    protected SaveStorePOSConnection(com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StorePOSConnection content) {
      super(Storeendpoint.this, "POST", REST_PATH, content, com.asaan.server.com.asaan.server.endpoint.storeendpoint.model.StorePOSConnection.class);
    }
