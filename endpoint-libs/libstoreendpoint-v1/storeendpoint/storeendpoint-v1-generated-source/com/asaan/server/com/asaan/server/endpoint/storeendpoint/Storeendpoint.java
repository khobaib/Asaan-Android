...
public class Storeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public PlaceOrder placeOrder(java.lang.Long storeId, java.lang.String order) throws java.io.IOException {
    PlaceOrder result = new PlaceOrder(storeId, order);
    initialize(result);
    return result;
  }

  public class PlaceOrder extends StoreendpointRequest<Void> {

    private static final String REST_PATH = "placeOrder/{storeId}/{order}";
     ...
     * @since 1.13
     */
    protected PlaceOrder(java.lang.Long storeId, java.lang.String order) {
